...
const fields = "id,name,destination,destination_country_code,first_city,start_date,end_date,cover_photo_url,owner_id,home_base_lat,home_base_lng,home_base_map_url,default_vehicle_capacity,currency,transport_base_fare,transport_per_km_rate,created_at";
